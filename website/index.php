	            ...
	            <div class="row">
	                ...
	                <div class="info col-md-8 col-12">
	                    ...
	                    <div class="contact float-right mt-4">
	                        ...
	                        <p class="email"><i class="fas fa-envelope"></i><a href="contact.php">example@website.com</a></p>
	                    </div>
	                </div>
	            </div>
            </div>
	                    ...
	                    <ul class="nav navbar-nav">
	                        ...
	                        <li class="nav-item dropdown">
	                            ...
	                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="courses.php"> ALL Service</a>
	                                <a class="dropdown-item" href="CT.php">Council Tax</a>
	                                <a class="dropdown-item" href="WR.php">Waste and recycling</a>                
	                                <a class="dropdown-item" href="School.php">Schools and learning</a>                
	                                <a class="dropdown-item" href="House.php">Housing</a>                                 
	                            </div>
                                <!--dropdown-menu-->
	                        </li>
	                        ...
	                        <li class="nav-item dropdown">
	                            ...
	                            <div class="dropdown-menu">
	                                ...
	                                <a class="dropdown-item" href="team.php">Leadership Team</a>
                    ...
                    <div id="news-carousel" class="news-carousel carousel slide">
                        <div class="carousel-inner">
                            <div class="item carousel-item active"> 
	                            <div class="row">
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Award Giving Ceremony</a></h2>
	                                    ...
	                                    <a class="read-more" href="news-single.php">Read more<i class="fas fa-chevron-right"></i></a>                
	                                </div>
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Staff member Gathering</a></h2>
	                                    <p>The city council's website recently featured an article about a staff member gathering event.</p>
	                                    <a class="read-more" href="news.php">Read more<i class="fas fa-chevron-right"></i></a>
	                                    <img class="thumb rounded-pill" src="assets/images/news/news-thumb-2.jpg"  alt="" />
	                                </div>
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Tribute to Mayer M.A. Sattar</a></h2>
                            ...
                            <div class="item carousel-item"> 
	                            <div class="row">
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Mayer M. A. Sattar</a></h2>
	                                ...
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Conference</a></h2>
	                                ...
	                                <div class="col-lg-4 col-12 news-item">
	                                    <h2 class="title"><a href="news.php">Student Practical Training</a></h2>
                ...
                <div class="col-lg-6 col-12">
                    <section class="course-finder rounded shadow">
                        ...
                        <div class="section-content">
                            ...
                            <a class="read-more" href="courses.php">View all our courses<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </section>
                            ...
                            <div id="testimonials-carousel" class="testimonials-carousel carousel slide">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item item">
                                        ...
                                        <div class="source">
                                            <p class="people"><span class="name">Deepak Rana</span></p>
                                            <img class="profile" src="assets/images/testimonials/testimonial-6.jpg"  alt="" />
                                        </div>                 
                                    </div>
                                </div>
                            </div>
                ...
                <div class="footer-col col-lg-3 col-md-4 col-12 about">
                    <div class="footer-col-inner">
                        ...
                        <ul>
                            ...
                            <li><a href="terms-and-conditions.php"><i class="fas fa-caret-right"></i>Terms & Conditions</a></li>
                        </ul>
                    </div>
                </div>
