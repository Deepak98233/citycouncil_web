                        ...
                        <div class="events-wrapper col-lg-8 col-md-7 col-12">                         
                            <article class="events-item row page-row has-divider clearfix">
                                ...
                                <div class="details col-lg-11 col-md-10 col-12">
                                    ...
                                    <p class="desc">From community festivals to educational workshops, there's always something happening to bring our community together. </p>                       
                                </div>
                            </article>
                            <article class="events-item row page-row has-divider clearfix">
                                <div class="date-label-wrapper col-lg-1 col-md-2 col-12">
                                ...
                                <div class="details col-lg-11 col-md-10 col-12">
                                    ...
                                    <p class="desc">Join us for an enriching learning experience! Our upcoming learning event offers a unique opportunity to expand your knowledge, acquire new skills, and connect with fellow learners. From interactive workshops to engaging seminars, our learning event covers a diverse range of topics to cater to various interests and learning styles.</p>                       
                                </div>
                            </article>
                            <article class="events-item row page-row has-divider clearfix">
                                <div class="date-label-wrapper col-lg-1 col-md-2 col-12">
                                ...
                                <div class="details col-lg-11 col-md-10 col-12">
                                    ...
                                    <p class="desc">Get ready to take the next step in your career journey at our upcoming Career Fair Event! Whether you're exploring new job opportunities, seeking career advice, or looking to connect with potential employers, our event is the perfect platform to help you achieve your career goals.</p>                       
                                </div>
                            </article>
                            <article class="events-item row page-row has-divider clearfix">
                                <div class="date-label-wrapper col-lg-1 col-md-2 col-12">
                            ...
                            <section class="widget has-divider">
                                ...
                                <article class="news-item row">       
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-single.php">Award giving ceremony</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-single.php">Rag day 2023</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-single.php">Tribute to Mayer M.A Sattar</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-single.php">Mayer M.A Sattar Biography</a></h4>
                                    </div>
                                </article>
                            </section>
                        </aside>
