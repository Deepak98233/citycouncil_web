                ...
                <header class="page-heading clearfix">
                    ...
                    <div class="breadcrumbs float-right">
                        <ul class="breadcrumbs-list">
                            ...
                            <li><a href="news.php">News</a><i class="fas fa-angle-right"></i></li>
                            ...
                            <section class="widget has-divider">
                                ...
                                <article class="news-item row">       
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-1.php">Morbi bibendum consectetuer vulputate sollicitudin</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-1.php">Sed tincidunt urna eget turpis pretium hendrerit</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
                                    ...
                                    <div class="details col-xl-10 col-9">
                                        <h4 class="title"><a href="news-1.php">Duis scelerisque erat iaculis</a></h4>
                                    </div>
                                </article>
                                <article class="news-item row">       
                                    <figure class="thumb col-xl-2 col-3">
